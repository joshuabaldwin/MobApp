...
{
    // Joshua: Added login backdoor for testing and development
    if (([self.username.text caseInsensitiveCompare:@"JSB"] == NSOrderedSame) &&
        ([self.passcode.text caseInsensitiveCompare:@"JSB"] == NSOrderedSame))
    {
